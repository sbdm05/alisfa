    ...
    <div class="enveloppe videos">
      ...
      <div class="bloc_video">
        <a href="<?php echo get_theme_mod('temoignage_lien_2', get_template_directory_uri().'/video/video-01.mp4' ); ?>" class="cadre_video fancybox fancybox.iframe">
          ...
          <div class="titre_cadre_video_temoignage">Témoignages</div>
          <div class="legende_cadre_video_temoignage"><?php echo get_theme_mod ('temoignage_nom_2', 'Anne, directrice'); ?></div>
          <div class="bouton_lecture_video"></div>
        </a>
        <div class="commentaire_cadre_video"><strong><?php echo get_theme_mod ('temoignage_description_2', 'Anne, accus magnatur, ut aut que idenet raecum qui omnit hilluta nonsecae repel ipidunt quod ma dolescit ute moluptatum quo velit.'); ?></strong></div>
      </div>
      ...
      <div class="bloc_video">
        <a href="<?php echo get_theme_mod('temoignage_lien_3', get_template_directory_uri().'/video/video-01.mp4' ); ?>" class="cadre_video fancybox fancybox.iframe">
          ...
          <div class="titre_cadre_video_temoignage">Témoignages</div>
          <div class="legende_cadre_video_temoignage"><?php echo get_theme_mod ('temoignage_nom_3', 'Loïc, auxiliaire de puériculture'); ?></div>
          <div class="bouton_lecture_video"></div>
        </a>
        <div class="commentaire_cadre_video"><strong><?php echo get_theme_mod ('temoignage_description_3', 'Loïc, accus magnatur, ut aut que idenet raecum qui omnit hilluta nonsecae repel ipidunt quod ma dolescit ute moluptatum quo velit.'); ?></strong></div>
      </div>
       ...
       <div class="bloc_video">
        <a href="<?php echo get_theme_mod('temoignage_lien_4', get_template_directory_uri().'/video/video-01.mp4' ); ?>" class="cadre_video fancybox fancybox.iframe">
          ...
          <div class="titre_cadre_video_temoignage">Témoignages</div>
          <div class="legende_cadre_video_temoignage"><?php echo get_theme_mod ('temoignage_nom_4', 'Claire, éducatrice de jeunes enfants'); ?></div>
          <div class="bouton_lecture_video"></div>
        </a>
        <div class="commentaire_cadre_video"><strong><?php echo get_theme_mod ('temoignage_description_4', 'Claire, accus magnatur, ut aut que idenet raecum qui omnit hilluta nonsecae repel ipidunt quod ma dolescit ute moluptatum quo velit.'); ?></strong></div>
      </div>
